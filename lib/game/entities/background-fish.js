...
ig
    ...
    .defines(function () {
        ...
        EntityBackgroundFishLarge = EntityBackgroundFish.extend({
            frame_name: "background_fish_large",
            sprite_size: {x: 60, y: 38}
        });

        EntityBackgroundFishMedium = EntityBackgroundFish.extend({
            frame_name: "background_fish_medium",
            sprite_size: {x: 46, y: 28}
        });

        EntityBackgroundFishSmall = EntityBackgroundFish.extend({
